...
import {iphone,s24,blazer,shirt} from "../productDetails";
import { useParams } from 'react-router-dom';
// import {useCallManager} from '../components/chatbot/CallManager';
...
//   const {setVoiceType} = useCallManager();
    ...
    return (
        <div>
            ...
            <div className='relative'>
                ...
                <div className="bg-transparent py-10 px-5 flex flex-col items-center justify-center gap-1 w-full">
                    <div className="flex flex-row justify-center items-stretch min-h-[600px] w-full">
                            ...
                            <div className="flex flex-row justify-between items-center h-[40%] gap-4 w-full">
                                <div className="w-[50%] h-full">
                                    <img
                                        ...
                                        onClick={() => handleImageChange(`${data.img2}`,'')}
                                    />
                                </div>
                                <div className="w-[50%] h-full">
                                    <img
                                        ...
                                        onClick={() => handleImageChange(`${data.img3}`,'')}
                                    />
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="px-8 py-2 w-[50%] flex flex-col justify-start items-start h-full text-md text-text_gray">
                            <p className="mb-2">{data?.catg1}</p>
                            <p>{data?.catg2}</p>
                            <div className="flex flex-col justify-center items-start p-0 my-4 gap-2">
                                <p className="text-2xl text-black mb-2">{data?.name}</p>
                                <p><span className="text-2xl font-bold text-text_hover">&#8377;{data?.price1} - &#8377;{data?.price2}</span> & Free Shipping</p>
                                <p>
                            ...
                            <div className="flex gap-2 my-4">
                                <div
                                    ...
                                    onClick={() => handleImageChange(`${data.img1}`,'red')}
                                    title="Red"
                                />
                                <div
                                    ...
                                    onClick={() => handleImageChange(`${data.img2}`,'blue')}
                                    title="Blue"
                                />
                                <div
                                    ...
                                    onClick={() => handleImageChange(`${data.img3}`,'green')}
                                    title="Green"
                                />
                                </div>
                            </div>
                            ...
                            <div className='flex flex-col my-5'>
                                <p className='font-bold'>{data?.offer.off}</p>
                                <p className='flex'><span className='m-1'><IoIosCheckmarkCircle /></span>{data?.offer.offer1}</p>
                                <p className='flex'><span className='m-1'><IoIosCheckmarkCircle /></span>{data?.offer.offer2}</p>
                                <p className='flex'><span className='m-1'><IoIosCheckmarkCircle /></span>{data?.offer.offer3}</p>
                            </div>
                            ...
                            <div className='my-2 flex flex-col gap-4 w-full'>
                                ...
                                <div className='flex flex-row justify-center items-center h-auto bg-gray-100 rounded-lg'>
                                    <div className='w-[100%] flex flex-col items-start justify-between gap-2 p-4'>
                                        <p className='text-xl font-bold text-black'>Details</p>
                                        <hr className="border-t-1 border-text_hover my-1 w-20" />
                                        <p>{data?.description.des}</p>
                                        <ul className='text-text_hover font-bold'>
                                            <li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.description.des1}</li>
                                            <li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.description.des2}</li>
                                            <li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.description.des3}</li>
                                            {data?.description.des4!="" && (<li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.description.des4}</li>)}
                                        </ul>
                                    </div>
                                ...
                                <div className='flex flex-row justify-center items-center h-auto bg-gray-100 rounded-lg'>
                                    ...
                                    <div className='w-[100%] flex flex-col items-start justify-between gap-2 p-4'>
                                        ...
                                        <ul className='flex flex-col items-start'>
                                            <li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.features.feat1}</li>
                                            <li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.features.feat2}</li>
                                            <li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.features.feat3}</li>
                                            {data?.features.feat4 && (<li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.features.feat4}</li>)}
                                            {data?.features.feat5 && (<li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.features.feat5}</li>)}
                                        </ul>
                                    </div>
                                </div>
                                ...
                                <div className='flex flex-row justify-center items-center h-auto bg-gray-100 rounded-lg'>
                                    <div className='w-[100%] flex flex-col items-start justify-between gap-2 p-4'>
                                        <p className='text-xl font-bold text-black'>Specifications</p>
                                        <hr className="border-t-1 border-text_hover my-1 w-20" />
                                        {/* <p>
                                        ...
                                        <ul className='text-text_hover font-bold'>
                                            <li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.specification.spec1}</li>
                                            <li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.specification.spec2}</li>
                                            <li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.specification.spec3}</li>
                                            {data?.specification.spec4 && (<li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.specification.spec4}</li>)}
                                            {data?.specification.spec5 && (<li className='flex'><span className='mr-1 mt-1'><IoIosCheckmark /></span>{data?.specification.spec5}</li>)}
                                        </ul>
                                    </div>
                                    {/* <div className='w-[30%] p-5'>
                                        <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRx7xWyiDsE-dWpduLtsrqV0i_k8-BSOYGrng&s" className=''></img>
